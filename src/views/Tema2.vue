  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-md-10.col-lg-4.mb-4.mb-xl-0
        .tarjeta-numerada.color-acento-contenido.p-5
          .tarjeta-numerada__numero
            .h2 2
          h4 Lento de conseguir
          p Por lo que es importante dedicarle tiempo y diseñar una buena campaña que reporte unos resultados acordes a los objetivos que pretende lograr la empresa.
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-6
        .tarjeta.tarjeta-morada2.mb-3
          ...
          .p-4  
            h4 Autoridad
            p Un sitio web tiene autoridad cuando es popular y esta popularidad se mide según el número de enlaces que apuntan hacia ella. Para mejorar la autoridad de una web se usan técnicas de SEO off site5, entre las que destaca el <i>linkbuilding</i>.

    p.mb-5 De otra parte cobra mucha relevancia el tipo de estrategias que se utilizan, las que presenta la SEO para tenerlas en cuenta son las siguientes:
    ...
    .row.justify-content-center.align-items-center.mb-5
      ImagenInfografica.color-acento-contenido
        ...
        .tarjeta.tarjeta-naranja.p-3(x="13%" y="40%" numero="+")
          p <b>Planificación de contenidos:</b> elaborar un plan editorial, consultando con compañeros o interesados, con el fin de obtener ideas sobre qué artículos publicar o incluso invitándolos a que los escriban ellos mismos.

        .tarjeta.tarjeta-naranja.p-3(x="27%" y="62%" numero="+")
          p <b>Estudiar la competencia:</b> analizar su estrategia, sus palabras claves y su tipo de publicaciones, esto con el fin de lograr obtener una mejor posición que ellos, por esto es necesario saber qué hacen y así poder superarlos.

        .tarjeta.tarjeta-naranja.p-3(x="39%" y="40%" numero="+")
          p <b>Escuchar la competencia:</b> esta escucha debe ser constante; es preciso estudiar aquellas webs de la competencia que estén mejor posicionadas para conocer lo qué están haciendo, de qué manera, que estrategias utilizan ellos y como competir y mejorarlos, en esto, herramientas como: Ahrefso Open Site Explorer puede ayudarle mucho.

        .tarjeta.tarjeta-naranja.p-3(x="51%" y="62%" numero="+")
          p <b>Evitar comportamientos que puedan penalizarlos:</b> copiar contenido, realizar intercambio de enlaces, comentarios masivos en Blogs, enlaces en sitios de temáticas totalmente diferentes, son comportamientos detectados por los buscadores y que pueden hacer que descienda la visibilidad.

        .tarjeta.tarjeta-naranja.p-3(x="64%" y="40%" numero="+")
          p <b>Medición de resultados:</b> en una campaña SEO, se dispone de herramientas destinadas a ayudar en la medición de los resultados arrojados por la campaña que se está desarrollando y poder analizar para elevar acciones de mejora.

        .tarjeta.tarjeta-naranja.p-3(x="78%" y="62%" numero="+")
          p <b>Establecimiento de campañas por periodos de tiempo:</b> ponga en marcha la estrategia y observe los resultados. Una vez terminada y analizada, ajuste todo lo necesario y vuelva a realizar otra poniendo en práctica lo aprendido de los resultados de la campaña anterior.

        .tarjeta.tarjeta-naranja.p-3(x="90%" y="40%" numero="+")
          p <b>Actualice su web:</b> una campaña SEO puede suponer cambios en su página web, procure tener relación directa con el técnico encargado de su mantenimiento.
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-lg-8
            .titulo-segundo.color-acento-contenido
              h2 SEO (Optimización de motores de búsqueda)

            p.mb-5 Con la intención de profundizar en el tema, le invitamos a que acceda en los materiales complementarios de este subtema, donde se relaciona el video “¿Qué es SEO? y ¿Cómo funciona?”. En este video podrá conocer con mayor profundidad este concepto.

            .col-sm-auto
              a.boton.color-acento-botones(href="https://www.youtube.com/watch?v=m6vikmaiS0Q&ab_channel=MiPymeOnline" target="_blank")
                span Enlace
                i.fas.fa-link

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-9
        p Las campañas SEM (<i>Search Engine Marketing</i> o también denominado <i>Marketing</i> en buscadores) son una forma rápida, económica y eficaz de hacer publicidad, conseguir clientes potenciales y generar ventas. Esta técnica es muy usada debido a que ofrece resultados inmediatos y la página de la empresa que se quiere posicionar aparecerá en los buscadores de un día para otro, obteniendo visitas rápidamente. Quienes utilizan el sistema SEM de publicidad, pueden medir con gran exactitud el retorno de su inversión debido a la gran cantidad de estadísticas disponibles para tal efecto. Además, permite una potente configuración de las campañas mediante una segmentación por múltiples criterios.

        p A continuación se profundiza sobre los conceptos básicos para la creación de una estrategia SEM, esto es
    ...
    .row.justify-content-center.align-items-center.mb-5
      AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta-acordion")
        .row.p-4(titulo="Conceptos básicos del SEM")
          ul.lista-ul--color.fa-ul2
            li 
              i.fas.fa-check
              p.mb-0 #[b Palabra clave o #[i keyword]:] son la base en la que se sustenta todo el marketing en buscadores, son los criterios que harán que el anuncio se muestre a unos u otros usuarios.
            li 
              i.fas.fa-check
              p.mb-0 #[b Anuncio de texto:] es el tipo de anuncio estándar que se muestra en los buscadores, está conformado por un título, dos líneas de texto y un enlace personalizable.
            li 
              i.fas.fa-check
              p.mb-0 #[b Grupo de anuncios:] son conjuntos de anuncios y palabras claves, que a su vez se agrupan en campañas en las que se puede definir el presupuesto diario y los países o territorios donde aparecerán los anuncios.
            li 
              i.fas.fa-check
              p.mb-0 #[b Red de búsqueda:] parte del buscador en la que pueden aparecer sus anuncios.
            li 
              i.fas.fa-check
              p.mb-0 #[b Impresiones:] número de veces que se ha mostrado un anuncio.
            li 
              i.fas.fa-check
              p.mb-0 #[b Clicks:] número de veces que se ha hecho click en un anuncio.
            li 
              i.fas.fa-check
              p.mb-0 #[b Nivel de calidad:] puntuación otorgada por Google de una palabra clave y de un anuncio y que determinan su costo.
        
        .row.p-4(titulo="Claves SEM")
          ul.lista-ul--color.fa-ul2
            li 
              i.fas.fa-check
              p.mb-0 #[b Redacción y optimización del texto de los anuncios:] además de atraer muchos más usuarios, también supondrá un mejor posicionamiento dentro del grupo de los enlaces patrocinados, lo que hace que anuncios que tienen mejor porcentaje de clicks salgan por delante y otros sean relegados a las últimas posiciones o incluso eliminados de los resultados de búsqueda.
            li 
              i.fas.fa-check
    ...
    .row.align-items-center.mb-5
      .col-lg-4
        figure
          img(src='@/assets/curso/temas/tema2/titulo2.svg', alt='Imágen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-5
      AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta-acordion2")
        ...
        .row.p-4(titulo="Pago por click")
          p Con esto la campaña cuesta dinero solo si se consiguen resultados. Gracias a la configurabilidad de la herramienta se puede controlar y ajustar el presupuesto de manera dinámica, y otros conceptos como el número máximos de clics por día, asegurando la rentabilidad de la campaña.

        .row.p-4(titulo="Rapidez")
          p La publicidad en buscadores permite alcanzar resultados relativamente rápidos y a gran escala.

        .row.p-4(titulo="Sencillez de uso")
          p Puede ser usado sin grandes conocimientos técnicos.

        .row.p-4(titulo="Accesibilidad")
          p Una de las características de estas campañas es la de la obtención de grandes resultados con inversiones no demasiado grandes.

        .row.p-4(titulo="Segmentación")
          p Por último, otro punto fuerte de esta herramienta son sus grandes posibilidades de segmentación. Al estar orientada a palabras clave, llega al público que está activamente interesado en el producto.

    separador
    #t_2_2.titulo-segundo.color-acento-contenido
       h2 2.2 Técnicas de masificación de información

    p El objetivo de toda empresa en la era actual es masificar su marca, producto o servicio. Gracias a las herramientas del Marketing Digital esta labor puede ser un poco más fácil debido al alcance y penetración en la audiencia. La cantidad de “Me Gusta” o “Me Encanta” en la FanPage de Facebook o los suscriptores en Twitter o los seguidores en Instagram cobran importancia porque indica la aceptación de la empresa u oferta que es presentada.

    p.mb-5 A continuación, se presentan algunas de las plataformas más populares que ayudan a las empresas a masificarse, conseguir clientes y por consiguiente aumentar sus ventas:

    .tarjeta.tarjeta--azul.bg-slyder.mb-5
      SlyderA(tipo="b").p-5
        .row
          .col-md-7.mb-4.mb-md-0
            h4 WhatsApp + Facebook + Instagram
        ...
        .row
          .col-md-7.mb-4.mb-md-0
            ...
            p Al crear un Fan Page en Facebook, le da la opción de integrar un botón de llamado a la acción y este puede configurarse para que con tan sólo un click lo lleve a la App de WhatsApp y generar una conversación más personalizada empresario-cliente.
        ...
        .row
          .col-md-7.mb-4.mb-md-0
            ...
            p Ahora bien, desde la configuración de la Fan Page, se puede integrar con el perfil de Instagram, creando una plataforma omnicanal para mejor experiencia y comunicación del cliente; este aspecto es fundamental, debido a que el usuario tendrá disponible tres canales de comunicación a tan solo un click (Messenger, WhatsApp y Direct).
        ...
        .row
          .col-md-7.mb-4.mb-md-0
            ...
            p Es un sitio web estadounidense especializado para crear o compartir videos de diferente temática (películas, programas de televisión, vídeos musicales, video tutoriales, entre otros.), así como contenido amateur de juegos o situaciones cotidianas de las personas.
        ...
        .row
          .col-md-7.mb-4.mb-md-0
            h4 Email Marketing o E-mailing
    ...
    .row.justify-content-center.align-items-center.mb-5
      p La optimización de las redes sociales es una forma eficaz de conseguir y mantenerse por delante de la competencia en los canales de las redes sociales como Twitter, LinkedIn, Facebook, YouTube, entre otros.

      p La optimización de los medios sociales puede definirse como un proceso de acceso a nuevos clientes mediante el descubrimiento de los canales de medios sociales predominantes; existen varias técnicas y estrategias, como los canales RSS, los sitios web de medios sociales, los blogs y los videos, y los sitios web de noticias sociales.

      p A continuación, se presenta los beneficios de la implementación de técnicas de optimización, que son los siguientes:
    ...
    .row.justify-content-center.align-items-center.mb-5
      AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta-acordion")
        ...
        .row.p-4(titulo="Video")
          p Los post de video son aún más llamativos hoy en día. En el video post, usted puede inspirar a la audiencia y hacerles saber acerca de sus productos/servicios y cómo esos productos/servicios les ayudarán. Esta estrategia se está haciendo popular en los últimos años y se utiliza como una parte importante para las ventas. 

        .row.p-4(titulo="Blogging")
          p Es una de las técnicas más populares porque siempre tiene contenido genuino de calidad y la gente puede encontrar resultados originales. Los profesionales están utilizando el blogging como la técnica principal para la optimización de cualquier sitio web mediante el uso de backlinks en el blog y el contenido sobre el sitio web de la empresa. Las palabras clave también se utilizan en el contenido para llegar a una audiencia máxima de internet.

        .row.p-4(titulo="Contenido viral")
          p Usted debe tratar de crear contenido que puede ser viral fácilmente. Será muy exitoso en el marketing de medios sociales para cualquier sitio web si tiene cualquier contenido escrito, imagen o vídeo y es lo suficientemente interesante para conseguir ser viral. 
        ...
        .row.p-4(titulo="Aumentar la visibilidad social")
          p Los medios sociales son una gran herramienta para establecer una relación con su público sin comprometer sus preferencias. Los contenidos compartidos, blogs, posts, etc. hacen que la gente conozca su marca y su sitio web. Los medios sociales permiten escribir información sobre el negocio con un enlace al sitio web, lo que ayuda a generar más clientes potenciales y a obtener una ventaja sobre los competidores. 

    separador
    #t_2_4.titulo-segundo.color-acento-contenido
       h2 2.4 Métrica: técnicas de identificación y barrido

    .row.justify-content-center.align-items-center.mb-5
      p Las métricas son los datos que se recopilan y utilizan para medir el rendimiento de sus campañas en las redes sociales. Estas métricas ayudan a determinar si el tiempo que se dedica al marketing en redes sociales está dando sus frutos en cuanto al retorno de la inversión. Estas métricas dan una idea de cómo ven los demás la empresa y su contenido; también le dan una visión precisa de su inversión en esta plataforma de marketing en constante cambio.

      p Las siguientes tres métricas son las más universales y se deben tener en cuenta para el logro de los objetivos de una empresa:
    ...
    .row.justify-content-center.align-items-center.mb-5
      ImagenInfografica.color-acento-botones
        ...
        .tarjeta.color-acento-contenido.p-4(x="40.5%" y="41.8%" numero="1")
          p #[b Alcance:] se refiere al número de personas que realmente ven su contenido, le ayudará a entender hasta dónde llega su contenido y cuán grande es su audiencia.

        .tarjeta.color-acento-contenido.p-4(x="36.6%" y="65%" numero="2")
          p #[b Impresiones:] es el número de veces que su contenido se muestra o se presenta a una audiencia, se basa en si una persona hace o no clic en su contenido.

        .tarjeta.color-acento-contenido.p-4(x="64.4%" y="26.5%" numero="3")
          p #[b Compromiso:] considerada la más importante, se describe como el objetivo final de su contenido. Esta métrica le dice que la gente está actuando en su contenido, y eso hace que sea muy probable que se aventuren a visitar su sitio, blog o página de producto.


    p.mb-5 Aunque el compromiso no puede darse sin el alcance y las impresiones, es una calle de doble sentido. El algoritmo está ajustado para que una publicación con un compromiso significativo se muestre frente a más audiencias lo que significa más impresiones.
