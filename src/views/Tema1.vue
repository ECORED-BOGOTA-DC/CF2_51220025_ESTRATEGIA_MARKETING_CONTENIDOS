...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-lg-8
            .titulo-segundo.color-acento-contenido
              h2 Casos de uso de Big data

            p.mb-5 Para ampliar la información sobre la importancia del Big data, descargue el siguiente documento.
    ...
    p Un algoritmo de redes sociales es una compilación de reglas y datos que toman decisiones sobre lo que los usuarios quieren ver en la plataforma. #[b Los sitios de redes sociales crean algoritmos únicos para cada persona que utiliza el sitio,] lo que significa que no habrá dos personas que tengan exactamente el mismo hilo de noticias en las redes sociales. Esencialmente, los algoritmos de las redes sociales analizan el comportamiento de los usuarios y priorizan el contenido que la plataforma cree que el usuario quiere ver y con el que es más probable que participe.

    p.mb-5 Cada una de las principales plataformas de redes sociales tiene su propia versión de un algoritmo de estilo #[b #[i "news feed"]]; a continuación, se ofrece un resumen de lo que los algoritmos de estas plataformas tienen en cuenta a la hora de priorizar el contenido, esto es:

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-6
        .tarjeta.tarjeta-morada.mb-3
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-8
        ...
        p El <i>software</i> de gestión de datos permite identificar patrones en los datos que ayudan a tomar decisiones de <i>marketing</i> más inteligentes sobre dónde invertir el tiempo y el presupuesto. El objetivo de casi cualquier comercializador es maximizar la eficacia de las actividades de <i>marketing</i> y justificar las inversiones; con las herramientas de análisis de marketing, los equipos pertenecientes a esta área pueden mejorar sus esfuerzos y demostrar su valor.

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-11
        .tarjeta-naranja.p-4
          p Las mejores herramientas de análisis de marketing le permiten hacer un seguimiento como el siguiente:
    ...
    p.mb-5 A continuación, se enumera algunos factores que puede tener en cuenta para ayudar a encontrar las herramientas y el <i>software</i> de análisis de <i>marketing</i> adecuados para su empresa:
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-md-10.col-lg-3.mb-4.mb-xl-0
        .tarjeta-numerada.color-acento-botones.p-4
          .tarjeta-numerada__numero
            .h2 D
          p Si hay varias personas en sus equipos de marketing y ventas, asegúrese de elegir una herramienta de análisis de marketing que admita varios usuarios.
